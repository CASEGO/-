...
namespace Курсач
{
    public partial class service : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            this.услугиTableAdapter.Fill(this.aRMDataSet.Услуги);
            textBox1.Clear();
            textBox2.Clear();
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "aRMDataSet.Услуги". При необходимости она может быть перемещена или удалена.
            this.услугиTableAdapter.Fill(this.aRMDataSet.Услуги);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            myConnection.Open();
            dataGridView1.DataSource = услугиBindingSource;
        }
    }
}
